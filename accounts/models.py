...
class UserProfile(models.Model):
    ...
    image = models.ImageField(default='/person_2.jpg', upload_to=get_image_file_path)
...
class GroupProfile(models.Model):
    ...
    image = models.ImageField(default='media/group-chat-icon.jpg', upload_to=get_group_image_file_path)
